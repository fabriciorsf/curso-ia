...
""" PIPELINE COMPLETO (com busca híbrida: densa + esparsa):
...
# Visualizando os 2 vetores de consulta
...
results = qdrant.query_points(
    ...
    # Utiliza o método RRF (Reciprocal Rank Fusion) para combinar os resultados
